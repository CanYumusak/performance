...
const baseURL = "https://teamp.yumusak.dev:443/"
const query = "?Authorization=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJUaGlzSXNKdXN0U29tZUR1bW15SUQiLCJuYW1lIjoiQ2FuIFl1bXVzYWsiLCJpYXQiOjE1MTYyMzkwMjJ9.sqcx8dgQr4M68eicWJTB15_D8MhKCnFf6lCNk3ek8-4&user="

export default class PerformanceLineChart extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  async componentDidMount() {
    ...
    const api = baseURL + this.props.type + query + user
